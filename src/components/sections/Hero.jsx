...
const Hero = () => {
    return (
        <section className="relative min-h-screen lg:min-h-[130vh] top-5  w-full  text-white overflow-hidden ">
            ...
            <div className="relative h-full">
                ...
                {/* Text Content */}
                <div className=" absolute lg:left-167 translate-y-4/2 lg:w-full  z-30">
                    <h1 className="mb-[-20] ml-20 mt-12 lg:mb-0 lg:ml-0 lg:mt-0 text-[45px] md:text-[130px]  font-extrabold leading-[0.85] tracking-tight text-white/50">
                        POWER YOUR <br /> <span className="tracking-wide">PONTETIALE</span>
                    </h1>

                    <div className="  hidden lg:block lg:flex mt-6  lg:gap-6">
                ...
                {/* Right Image */}
                <div className="lg:hidden absolute right-9 top-30 z-20">
                    <Image
                        src="/hero.png" 
                        alt="gym"
                        width={300}
                ...
                <div className="hidden md:block lg:block  absolute right-12 top-30 z-20">
                    <Image
                        src="/hero.png" 
                        alt="gym"
                        width={1000}
